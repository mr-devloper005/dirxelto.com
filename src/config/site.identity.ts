export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'dirxelto',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Dirxelto',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'dirxelto.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://dirxelto.com',
